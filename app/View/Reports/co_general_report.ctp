...
function loan_officer_list(val){
    var url= '<?php echo $this->Html->url('/reports/ajaxLoanOfficerList/'); ?>'+val;
                        ...
                        <div class="box-body">
                            <div class="profile_info" style="width:100%; padding-bottom:20px;">
                                <ul>
                                    ...
                                    <li><strong>Organization name:</strong> <?=$loan_officer_summery['organization_details']['organization_name']?></li>
                                    ...
                                    <li><strong>Total Pending Application:</strong> <?=$loan_officer_summery['pending_application']?></li>
                                    ...
                                    <li><strong>Total Principal Collected:</strong> <?=$this->Number->currency($loan_officer_summery['total_principal_paid'],'',array('places'=>0))?></li>
                                    <li><strong>Total Interest Collected:</strong> <?=$this->Number->currency($loan_officer_summery['total_interest_paid'],'',array('places'=>0))?></li>
