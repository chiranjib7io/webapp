<script type="text/javascript">
			function calc_rate(feerate){
			     //alert(feerate);
				var amount, interest, instal, rate, loantype, interval, intervaltype;
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="box box-danger col-xs-12" style="padding-top:20px; padding-bottom:20px;">
                ...
                <?php echo $this->Form->input('Loan.loan_fee', array('type' => 'hidden','value'=>$org_data['Fee']['LAF'],'label'=>false)); ?>
                ...
                <div class="box-body col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                      ...
                      <?php echo $this->Form->input('Loan.loan_purpose', array('type' => 'textarea','placeholder'=>'Enter Loan Purpose','class'=>'form-control','required'=>'required','label'=>false)); ?>
