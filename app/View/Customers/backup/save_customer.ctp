          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="box box-danger col-xs-12" style="padding-top:20px; padding-bottom:20px;">
                <?php echo $this->Form->create('Customer',array('action'=>'save_customer',$emp_id)); ?>
                ...
                <div class="box-body col-md-6 col-sm-12">
					...
					<div class="form-group">
                      ...
                      <?php
							echo $this->Form->input('', array('type' => 'select','name'=>'data[Customer][kendra_id][]','options' => $kendra_list, 'class'=>'form-control', 'label'=>false));
						?>
                    </div><!-- /.form group -->
