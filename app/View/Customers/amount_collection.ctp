              ...
              <div class="box box-danger col-xs-12" style="padding-top:20px; padding-bottom:20px;">
               <!-- <div class="box-header">
                ...
                <div class="box-body col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                        <label for="Name">Gurdian Name: </label>
                        <span><?=!empty($account_data['Customer']['guardian_name'])?$account_data['Customer']['guardian_name']:'N/A'?></span>
                    </div>
                ...
                <div class="box-body col-md-6 col-sm-12">
                    ...
                    ?>
                    <div class="form-group">
                        <label for="Name">Loan Principal: </label>
                        <span id="cur_bal">Rs. <?=$account_data['Loan']['loan_principal']?></span>
                    </div>
                    
                    <div class="form-group">
                        <label for="Name">Loan Term: </label>
                        <span id="cur_bal"><?=$account_data['Loan']['loan_period'].' '.$account_data['Loan']['loan_period_unit']?></span>
                    </div>
                    
                    <div class="form-group">
                        <label for="Name">Current Overdraft Balance: </label>
                        <span id="cur_bal">Rs. <?=$loan_data['current_outstanding']?></span>
                    </div>
                  <!--  
                    <div class="form-group">
