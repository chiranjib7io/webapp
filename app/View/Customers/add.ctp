              ...
              <div class="box box-danger col-xs-12" style="padding-top:20px; padding-bottom:20px;">
               <!-- <div class="box-header">
                ...
                <div class="box-body col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                      <label for="Zip">Occupation</label>
                      <input type="number" class="form-control" id="zip" name="data[Customer][occupation]" placeholder="Enter Occupation" required="required">
                    </div><!-- /.form group -->
                ...
                <div class="box-body col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                      ...
                      <?php
						echo $this->Form->input('Idproof.id_proof_type', array('type' => 'select', 'options' => $this->Slt->id_proof_name(), 'class'=>'form-control', 'label'=>false, 'required'=>'required', 'empty' => 'Select Identity Type'));
					  ?>
                    </div><!-- /.form group -->
