...
$(function () {
    ...
    var table = $('#kendraListingTable').DataTable( {
                    ...
                    "ordering": true,
                    "info":     true,
                    "data": <?=$summary_data['best_wrost_data']['table_val'] ?>,
                    "deferRender": true
                });// table end
...
<!-- Content Header (Page header) -->
            <section class="content-header">
              ...
              <ol class="breadcrumb">
                ...
                <li class="active">Branch Summary</li>
              </ol>
            </section>
                  ...
                  <div class="col-xs-12">
                      ...
                      <div class="box no-border col-sm-12">
                        <div class="box-header no-border col-sm-12">
                          <h2 class="box-title" style="text-align:center;display:block; margin-top:10px;">Branch Information</h2>
                        </div><!-- /.box-header -->
                        <div class="box-body col-sm-12" style="padding-top:15px; padding-bottom:15px;">
                        	<div class="statistic_table1">
                            	...
                            	<div>
                                        ...
                                        <div>
                                        	<?=$branchLoanSummary['branch_manager_details']['first_name']?>  <?=$branchLoanSummary['branch_manager_details']['last_name']?>
                                        </div>
                            	...
                            	<div>
                                        ...
                                        <div>
                                        	<?=$branchLoanSummary['branch_manager_details']['email']?>
                                        </div>
                                ...
                                <div>
                                    	...
                                    	<div>
                                        	<strong>No. of Kendra:</strong>
                                        </div>
                                  		<div>
											<?=$branchLoanSummary['total_kendra']?>
                                        </div>
								 ...
								 <div>
                                    	...
                                    	<div>
                                  		...
                                  		<div>
											<?=$branchLoanSummary['total_cuatomer']?>
                                        </div>
								 ...
								 <div>
                                    	...
                                    	<div>
                                  		...
                                  		<div>
											<?=$branchLoanSummary['branch_details']['address'].', '.$branchLoanSummary['branch_details']['city'].', '.$branchLoanSummary['branch_details']['state'].', '.$branchLoanSummary['branch_details']['zip']?>
                                        </div>
                        ...
                        <div class="clear"></div>
                  		...
                  		<div class="col-md-4 col-sm-12">
                              <div class="box no-border">
                                <div class="box-header no-border">
                                  <h2 class="box-title" style="text-align:center;display:block; margin-top:10px;">Parcent Paid</h2>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                  		...
                  		<div class="col-md-4 col-sm-12">
                              <div class="box no-border">
                                ...
                                <div class="box-body">
                                    <h3 align="center"><?=$summary_data['overdue_data']['overdue_no']?>/<?=$this->Number->currency($summary_data['overdue_data']['total_overdue'], 'Rs.',array('places'=>0))?></h3>
                                </div><!-- /.box-body -->
                              </div><!-- /.box -->
                        </div><!-- /.col -->
                        <div class="col-md-4 col-sm-12">
                  		...
                  		<div class="col-md-4 col-sm-12">
                              <div class="box no-border">
                                ...
                                <div class="box-body">
                                    <h3 align="center"><?=$summary_data['new_loan_application']['no_of_loan']?>/<?=($summary_data['new_loan_application']['total_loan_principal']=='')?0:$this->Number->currency($summary_data['new_loan_application']['total_loan_principal'], 'Rs.',array('places'=>0))?></h3>
                                </div><!-- /.box-body -->
                              </div><!-- /.box -->
                        </div><!-- /.col -->
					 <div class="clear"></div>
                  		...
                  		<div class="col-md-4 col-sm-12">
                              <div class="box no-border">
                                ...
                                <div class="box-body">
                                    <h3 align="center"><?=$summary_data['approved_loan']['no_of_loan']?>/<?=($summary_data['approved_loan']['total_loan_principal']=='')?0:$this->Number->currency($summary_data['approved_loan']['total_loan_principal'], 'Rs.',array('places'=>0))?></h3>
                                </div><!-- /.box-body -->
                              </div><!-- /.box -->
                        </div><!-- /.col -->
                  		<div class="col-md-4 col-sm-12">
                              <div class="box no-border">
                                ...
                                <div class="box-body">
                                    <h3 align="center"><?=$summary_data['disbursed_loan']['no_of_loan']?>/ <?=($summary_data['disbursed_loan']['total_loan_principal']=='')?0:$this->Number->currency($summary_data['disbursed_loan']['total_loan_principal'], 'Rs.',array('places'=>0))?></h3>
                                </div><!-- /.box-body -->
                              </div><!-- /.box -->
                        </div><!-- /.col -->
                  		<div class="col-md-4 col-sm-12">
