              ...
              <div class="box box-danger col-xs-12" style="padding-top:20px; padding-bottom:20px;">
                ...
                <div class="box-body col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                      <label>Kendra</label>
						<?php
							echo $this->Form->input('Customer.kendra_id', array('type' => 'select', 'options' => $kendra_list, 'class'=>'form-control', 'label'=>false, 'required'=>'required', 'empty' => 'Select Kendra'));
						?>
                    </div><!-- /.form group -->
                ...
                <div class="box-body col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                      ...
                      <?php
						echo $this->Form->input('Idproof.id_proof_type', array('type' => 'select', 'options' => $identity_type, 'class'=>'form-control', 'label'=>false, 'required'=>'required', 'empty' => 'Select Identity Type'));
					  ?>
                    </div><!-- /.form group -->
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">
					  ...
					  <?php
						echo $this->Form->input('Customer.guardian_reletion_type', array('type' => 'select', 'options' => $relationship_type, 'required'=>'required', 'class'=>'form-control', 'label'=>false, 'empty' => 'Select Reletionship Type'));
					  ?>
                    </div>
