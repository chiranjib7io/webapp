			...
			<?php	echo $this->Form->input('id', array('type'=>'hidden')); ?>
                <div class="box-body col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                      <label>Kendra</label>
						<?php
							echo $this->Form->input('kendra_id', array('type' => 'select', 'options' => $kendra_list, 'class'=>'form-control', 'label'=>false, 'empty' => 'Select Kendra'));
						?>
                    </div><!-- /.form group -->
                ...
                <div class="box-body col-md-6 col-sm-12">
                	...
                	<div class="form-group">
                      ...
                      <?php echo $this->Form->input('cust_phone', array('type' => 'text','class'=>'form-control','placeholder'=>'Enter Contact No','required'=>'required','label'=>false)); ?>
                    ...
                    <div class="form-group">
                      ...
                      <?php
						echo $this->Form->input('Idproof.id_proof_type', array('type' => 'select', 'options' => $identity_type, 'class'=>'form-control','default'=>$cust_data['Idproof'][0]['id_proof_type'] , 'label'=>false, 'empty' => 'Select Identity Type'));
					  ?>
                    </div><!-- /.form group -->
                    ...
                    <div class="form-group">
                      <label for="GuardianName">Husband/ Guardian Name</label>
                      <?php echo $this->Form->input('guardian_name', array('type' => 'text','class'=>'form-control','placeholder'=>'Enter Husband/ Guardian Name','required'=>'required','label'=>false ));
