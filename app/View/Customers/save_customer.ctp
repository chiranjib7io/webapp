          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="box box-danger col-xs-12" style="padding-top:20px; padding-bottom:20px;">
                <?php echo $this->Form->create('Customer',array('action'=>'save_customer','enctype'=>'multipart/form-data',$emp_id)); ?>
                ...
                <div class="box-body col-md-6 col-sm-12">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo $this->Form->input('Customer.cust_address', array('type' => 'textarea','placeholder'=>'Enter Address','class'=>'form-control','label'=>false,'required'=>'required')); ?>
                    ...
                    <div class="form-group">
                      ...
                      <?php echo $this->Form->input('Customer.city', array('type' => 'text','placeholder'=>'Enter City','class'=>'form-control','label'=>false,'required'=>'required')); ?>
                    </div><!-- /.form group -->
                    
                    <div class="form-group">
                      <label for="State">State</label>
                      
                      <?php echo $this->Form->input('Customer.state', array('type' => 'text','placeholder'=>'Enter State','class'=>'form-control','label'=>false,'required'=>'required')); ?>
                      
                    </div><!-- /.form group -->
                    
                    <div class="form-group">
                      <label for="Zip">Zip</label>
                      <?php echo $this->Form->input('Customer.zip', array('type' => 'text','placeholder'=>'Enter Zip','class'=>'form-control','label'=>false,'required'=>'required')); ?>
					...
					<div class="form-group">
                      ...
                      <?php echo $this->Form->input('Customer.cust_phone', array('type' => 'number','placeholder'=>'Enter Contact No','class'=>'form-control','label'=>false,'required'=>'required')); ?>
				...
				<!-- /.form group -->
                    ...
                    <div class="form-group">
                      <label>Caste</label>
                      <?php
						echo $this->Form->input('Customer.caste', array('type' => 'select', 'options' => $this->Slt->caste_list(), 'class'=>'form-control', 'label'=>false, 'required'=>'required', 'empty' => 'Select Caste'));
					  ?>
                    </div><!-- /.form group -->
                    ...
                    <div class="form-group">
                        ...
                        <?php echo $this->Form->input('Customer.occupation', array('type' => 'text','placeholder'=>'Enter Occupation','class'=>'form-control','label'=>false,'required'=>'required')); ?>
					...
					<div class="form-group">
                      ...
                      <input type="date" class="form-control" value="<?=(!empty($emp_data['Customer']['cust_dob']))?$emp_data['Customer']['cust_dob']:''?>" name="data[Customer][cust_dob]" placeholder="Enter Date of Birth" required="required">
                    </div><!-- /.form group -->
                    
                    <div class="form-group">
                      <label for="GuardianName">Guardian Name</label>
                      
                      <?php echo $this->Form->input('Customer.guardian_name', array('type' => 'text','placeholder'=>'Enter Husband/ Guardian Name','class'=>'form-control','label'=>false,'required'=>'required')); ?>
                    </div><!-- /.form group -->
					
					 <div class="form-group">
                      <label for="Email">Relation with Guardian</label>
					  <?php
						echo $this->Form->input('Customer.guardian_reletion_type', array('type' => 'select', 'options' => $this->Slt->relationship_type(), 'required'=>'required', 'class'=>'form-control', 'label'=>false, 'empty' => 'Select Reletionship Type'));
					  ?>
                    </div>
                    ...
                    <div class="form-group">
                      <label>APL/BPL</label>
                      <?php
						echo $this->Form->input('Customer.apl_bpl', array('type' => 'select', 'options' => array('APL'=>'APL','BPL'=>'BPL'), 'class'=>'form-control', 'label'=>false, 'required'=>'required', 'empty' => 'Select APL or BPL'));
					  ?>
                    </div><!-- /.form group -->
                    ...
                    <div class="form-group">
                      <label>Credit Officer</label>
						<?php
							echo $this->Form->input('Customer.user_id', array('type' => 'select', 'options' => $co_list, 'class'=>'form-control', 'label'=>false, 'required'=>'required', 'empty' => 'Select Credit Officer'));
						?>
                    </div><!-- /.form group -->
