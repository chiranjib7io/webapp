              ...
              <div class="row">
              	<div class="col-md-12">
                    ...
                    <div class="box box-danger col-xs-12" style="padding-top:20px; padding-bottom:20px;">
                     ...
                     <?php
                 $total_amount=0;
                 if(!empty($kendra_data['Transaction'])){
              	...
              	<div class="col-xs-12"> 
                    <div class="box no-border" style="padding-top:20px; padding-bottom:20px; float:left">   
                      ...
                      <div class="col-sm-6">
                            ...
                            <?php echo $this->Form->input('LoanTransaction.insta_no', array('type' => 'hidden','value'=>!empty($kendra_data['Transaction'][0]['LoanTransaction']['insta_no'])?$kendra_data['Transaction'][0]['LoanTransaction']['insta_no']:0,'label'=>false)); ?>
                            <button type="submit" id="pay_btn" class="btn btn-success btn-lg  pull-right">Pay now</button>
