              ...
              <div class="box box-danger col-xs-12" style="padding-top:20px; padding-bottom:20px;">
                ...
                <div class="box-body col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                      ...
                      <?php echo $this->Form->input('Loan.loan_guranter1_amount', array('type' => 'text','value'=>0,'placeholder'=>'Enter Garanter 1 Contact No.','class'=>'form-control','label'=>false)); ?>
                    ...
                    <div class="form-group">
                      ...
                      <?php echo $this->Form->input('Loan.loan_guranter2_amount', array('type' => 'text','value'=>0,'placeholder'=>'Enter Garanter 1 Contact No.','class'=>'form-control','label'=>false)); ?>
