<script type="text/javascript">
   ...
   function load_plan(plan){
    ...
    function add_gurranter_row(){
        $.post("<?= $this->Html->url('ajax_guranter_row') ?>", function(data, status){
                $('#gurranter').append(data);
        });
    }
    function delete_gurranter_row(did){
        $('#'+did).remove();
    }
    
    function load_purpose(p){
        //alert(p);
        if(p=="Other"){
            $('#other_purpose').html('<label for="other purpose">Enter Other Purpose details</label><input type="text" name="data[Loan][loan_purpose]" class="form-control" required="required" value="" />');
        }
        else{
            $('#other_purpose').html("");
        }
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="box box-danger col-xs-12" style="padding-top:20px; padding-bottom:20px;">
                ...
                <?php echo $this->Form->input('Loan.region_id', array('type' => 'hidden','value'=>(!empty($cust_data['Region']['id']))?$cust_data['Region']['id']:0,'label'=>false)); ?>
                ...
                <div class="box-body col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                      <label for="NoOfPeriod">Loan Term</label>
                      <?php echo $this->Form->input('Loan.loan_period', array('type' => 'number','onChange'=>'calc_rate()','placeholder'=>'Enter No.','value'=>$org_data['Setting']['MNLPD'],'min'=>1,'max'=>$org_data['Setting']['MXLPD'],'class'=>'form-control','required'=>'required','label'=>false)); ?>
                    </div><!-- /.form group -->
                    
                    
                    <div class="form-group">
                      <label for="NoOfPeriod">Installment Payment Interval / Loan Term Unit</label>
                ...
                <div class="box-body col-md-6 col-sm-12">
                    <div class="box-header">
                      <h3 class="box-title">Fees Information</h3>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <?php
							echo $this->Form->input('Loan.loan_purpose', array('type' => 'select', 'options' => $this->Slt->loan_purpose_list(), 'class'=>'form-control', 'label'=>false,'required'=>'required','onchange'=>'load_purpose(this.value)' ,'empty' => 'Select Purpose'));
						?>
                ...
                <div class="box-body col-md-12 col-sm-12">
					...
					<div class="form-group col-md-4 col-sm-12">
						...
						<input type="text" class="form-control" id="savings_nominee" value="0" name="data[Loan][nominee_age]" placeholder="Enter Nominee age">
                    </div><!-- /.form group -->
                ...
                <div class="box-body col-md-12 col-sm-12">
                    <div class="box-header">
                      <h3 class="box-title">Gurranter Information</h3>
                    </div>
                    ...
                    <div>
                        <div class="form-group col-md-4 col-sm-12">
                          ...
                          <?php echo $this->Form->input('', array('type' => 'text','name'=>'data[guranter][guranter_name][]','placeholder'=>'Enter Gurranter Name','class'=>'form-control','label'=>false)); ?>
                        </div><!-- /.form group -->
                                        
                        <div class="form-group col-md-4 col-sm-12">
                          <label for="Garanter1ContactNo">Gurranter Account No.</label>
                          <?php echo $this->Form->input('', array('type' => 'text','name'=>'data[guranter][guranter_account_no][]','placeholder'=>'Enter Gurranter Account No.','class'=>'form-control','label'=>false)); ?>
                          
                        </div><!-- /.form group -->
                        
                        <div class="form-group col-md-4 col-sm-12">
                          <label for="Garanter1ContactNo">Gurranter Amount</label>
                          <?php echo $this->Form->input('', array('type' => 'text','name'=>'data[guranter][guranter_amount][]','value'=>0,'placeholder'=>'Enter Gurranter Amount','class'=>'form-control','label'=>false)); ?>
                ...
                <div class="box-body col-md-12 col-sm-12">
                        ...
                        <a href="javascript:void(0)" onclick="add_gurranter_row()">[+]Add another Guranter</a>
