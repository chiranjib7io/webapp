                ...
                <div class="col-xs-12 col-sm-10 col-md-8 col-lg-8 col-xs-push-0 col-sm-push-1 col-md-push-2 col-lg-push-2">
                	<div class="box box-primary" style="float:left">
                        ...
                        <div class="box-body" style="padding-bottom:20px; padding-top:20px;">
                            <?PHP echo $this->Form->create('Saving', array('method' => 'post')); ?>
                          		  <?php echo $this->Form->input('Saving.id', array('type' => 'hidden','value'=>'','label'=>false)); ?>                          
                            	<div class="input select form-group col-xs-12">
                                    <label for="CollectionDate">Select Kendra</label>
                                	<?php echo $this->Form->input("Saving.kendra_id", array(
                                        'options' => $kendra_list,
                                        'default' => $kendra_id,
                                        'empty' => 'Select Kendra',
                                        'required' => 'required',
                               ...
                               <label for="CollectionDate">Select Customer</label>
                               		<?php echo $this->Form->input("Saving.customer_id", array(
                                        'options' => $cust_list,
                                        'default' => $customer_id,
                               ...
                               <label for="CollectionDate">Security Amount</label>
                               		<input type="text" readonly="readonly" class="form-control" id="sec_fee" name="data[Saving][savings_amount]" value="<?=$sec_amt?>">
                                </div>                         
                                <div class="input-group col-xs-12" style="text-align:center">
                                
                                    <input type="submit" style="<?=$btn_disp?>" id="refund_btn" class="btn btn-success" value="Withdrawn Amount" onclick="return confirm('Are you sure you would like to refund the security amount?');" >
                                </div>
